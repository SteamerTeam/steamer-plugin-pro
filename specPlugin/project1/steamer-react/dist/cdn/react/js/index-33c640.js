...
/******/ 	__webpack_require__.p = "//s1.url.cn/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Wrapper = function (_Component) {
		...
		function Wrapper(props, context) {
			...
			_this2.state = {};
			_this2.firstGetAllData = false;
			_this2.loadTopNews = _this2.loadTopNews.bind(_this2);
			_this2.loadNewsList = _this2.loadNewsList.bind(_this2);
			_this2.loadData = _this2.loadData.bind(_this2);
			_this2.loadDataForScroll = _this2.loadDataForScroll.bind(_this2);
			return _this2;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stores = __webpack_require__(93);
	...
	var news = function news() {
		...
		switch (action.type) {
			...
			case _actions.LIKE_NEWS:
				...
				newState['listLike'].map(function (item, index) {
			...
			case _actions.DISLIKE_NEWS:
				...
				var newState = (0, _lodash2.default)({}, state);
				newState['listLike'] = newState['listLike'].filter(function (item, index) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _configureStore = __webpack_require__(91);
	...
	(0, _reactDom.render)(_react2.default.createElement(Root, null), document.getElementById('pages'));
